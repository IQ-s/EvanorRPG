function createEditbox(placeholderText, x, y, w, h, color, data)
    ...
    element.line = data.line or false
...
function renderEditbox(element)
    ...
    if element.line then
        dxDrawRectangle(x,y + h,w,1,tocolor(255,255,255,a))
        dxDrawRectangle(x,y + h,element.test,1,tocolor(56,175,89,a))
    else
...
--[[ local edit = createEditbox('test', 450, 450, 250, 45, {25, 25, 25}, {
     ...
     iconPadding = 12,
     line = true,
     icon = dxCreateTexture('data/images/i_login2.png')
 })
 showCursor(true)
